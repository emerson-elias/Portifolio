...
import Banner from '../projects/banner/banner_project'
        ...
        <>
            ...
            <section className={styles.all_project_container}>
                    ...
                    {['em breve', 'em breve', 'em breve', 'em breve', 'em breve', 'em breve' ,'em breve'].map((project, index) => (
                        <div className={styles.layers} key={index} ref={(el) => (containerRefs.current[index] = el)}>
                            <div className={styles.title_project}>
                                <h1>{project}</h1>
                            </div>

                            <div className={styles.box_img_project} ref={(el) => (bannersRefs.current[index] = el)}>
                                <img src="/assets/img/banner-projetos.jpg" alt={`BANNER PROJETO ${project.toUpperCase()}`} />
                            </div>

                            <a className={styles.svg} title="Acesse o projeto">

        ...
        <>
            ...
            <section className="about-container">
                ...
                <div className="about-info">
                    <img src={img} alt="Emerson Elias" />

                    <div className="about-description">
                        <h1>Olá, visitante! Seja bem-vindo!</h1>

                        <p>Meu nome é Emerson Elias, e atualmente trabalho como Analista de Suporte no <a href="https://www.grupolideronline.com.br/" target="_blank">Grupo Líder</a>. Minha paixão pela tecnologia começou cedo, ainda no ensino fundamental, quando descobri o quanto me fascinava aprender sobre esse universo em constante evolução.</p>

                        <p>Após concluir o ensino médio, cursei técnico em Desenvolvimento de Sistemas. Durante esse período, participei de diversos projetos internos, incluindo o <a href="https://sol.sbc.org.br/index.php/sbie/article/view/12799/12653" target="_blank">Potencializa 3D</a>, um dos mais marcantes para mim. Além disso, tive a oportunidade de ser monitor de algoritmos, o que reforçou ainda mais minha paixão pelo desenvolvimento.</p>

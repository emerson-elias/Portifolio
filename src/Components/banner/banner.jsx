...
export default function Banner() {
    ...
    return (
        <section className={style.banner_container}>
            <section className={style.banner_text_linear}>
            ...
            <section className={style.row}>
                ...
                <div className={style.layer_3} ref={layer3Ref}>

                    <div id={style.magnect_1} ref={magnect1Ref}>
                    ...
                    <div id={style.magnect_2} ref={magnect2Ref}></div>
                </div>

    ...
    return (
        <section className="about-container">
            ...
            <div className="about-bio">
                ...
                <span>de</span>
                <span data-aos="zoom-in">programação, <i className="fa-solid fa-code"></i></span>
                <span>sempre</span>
                <span>buscando</span>
                <span>novas</span>
                <span>formas</span>
                ...
                <span data-aos="zoom-in">dinâmicas</span>
                <span>& interativas,</span>
                <span>Com</span>
                <span>um</span>
                <span>foco</span>
                <span>na</span>
                <span data-aos="zoom-in">⟡ experiência ⟡</span>
                <span>do usuário</span>
                <span>& na otimização de</span>
                <span data-aos="zoom-in">──── performance
                ...
                <span data-aos="zoom-in">ferramentas</span>
                <span>modernas
